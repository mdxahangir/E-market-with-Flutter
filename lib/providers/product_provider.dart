...
//   Future<void> addProductMobile(Product product, XFile imageFile) async {
//     final newProduct = await ProductService.createProductMobile(product, File(imageFile.path));
//     _products.add(newProduct);
//     notifyListeners();
//   }

//   Future<void> addProductWeb(Product product, String fileName, Uint8List imageBytes) async {
//     final newProduct = await ProductService.createProductWeb(product, fileName, imageBytes);
//     _products.add(newProduct);
//     notifyListeners();
//   }
