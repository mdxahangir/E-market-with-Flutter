...
//     try {
//       // 1. Create product WITHOUT image URL first
//       final product = Product(
//         name: name,
//         description: description,
//         price: price,
...
//       // 2. Upload image with created product ID
//       final uploadSuccess = await uploadImage(createdProduct.id!);

//       if (uploadSuccess) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(content: Text('Product and image uploaded successfully!')),
//         );
//         Navigator.pop(context);
//       } else {
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(content: Text('Product saved but image upload failed')),
//         );
//       }
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(
...
//     try {
//       final uri = Uri.parse('http://YOUR_IP:8080/api/products/$productId/upload-image');
